...
static int saved_left_margin;
static int saved_right_margin;
static int saved_first_line_indent;
...
saveState(void)
{
    ...
    saved_left_margin             = ud->left_margin;
    saved_right_margin            = ud->right_margin;
    saved_first_line_indent       = ud->first_line_indent;
...
restoreState(void)
{
    ...
    ud->left_margin             = saved_left_margin;
    ud->right_margin            = saved_right_margin;
    ud->first_line_indent       = saved_first_line_indent;
